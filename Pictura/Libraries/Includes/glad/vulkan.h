/**
 * Loader generated by glad 2.0.0-beta on Thu Aug 15 11:31:38 2019
 *
 * Generator: C/C++
 * Specification: vk
 * Extensions: 180
...
GLAD_API_CALL int GLAD_VK_NVX_device_generated_commands;
...
typedef void (GLAD_API_PTR *PFN_vkCmdCopyAccelerationStructureNV)(VkCommandBuffer commandBuffer, VkAccelerationStructureNV dst, VkAccelerationStructureNV src, VkCopyAccelerationStructureModeNV mode);
...
typedef void (GLAD_API_PTR *PFN_vkCmdProcessCommandsNVX)(VkCommandBuffer commandBuffer, const VkCmdProcessCommandsInfoNVX * pProcessCommandsInfo);
...
typedef void (GLAD_API_PTR *PFN_vkCmdReserveSpaceForCommandsNVX)(VkCommandBuffer commandBuffer, const VkCmdReserveSpaceForCommandsInfoNVX * pReserveSpaceInfo);
...
typedef VkResult (GLAD_API_PTR *PFN_vkCreateIndirectCommandsLayoutNVX)(VkDevice device, const VkIndirectCommandsLayoutCreateInfoNVX * pCreateInfo, const VkAllocationCallbacks * pAllocator, VkIndirectCommandsLayoutNVX * pIndirectCommandsLayout);
...
#endif
typedef VkResult (GLAD_API_PTR *PFN_vkCreateObjectTableNVX)(VkDevice device, const VkObjectTableCreateInfoNVX * pCreateInfo, const VkAllocationCallbacks * pAllocator, VkObjectTableNVX * pObjectTable);
...
typedef void (GLAD_API_PTR *PFN_vkDestroyIndirectCommandsLayoutNVX)(VkDevice device, VkIndirectCommandsLayoutNVX indirectCommandsLayout, const VkAllocationCallbacks * pAllocator);
typedef void (GLAD_API_PTR *PFN_vkDestroyInstance)(VkInstance instance, const VkAllocationCallbacks * pAllocator);
typedef void (GLAD_API_PTR *PFN_vkDestroyObjectTableNVX)(VkDevice device, VkObjectTableNVX objectTable, const VkAllocationCallbacks * pAllocator);
...
#endif
typedef VkDeviceAddress (GLAD_API_PTR *PFN_vkGetBufferDeviceAddressEXT)(VkDevice device, const VkBufferDeviceAddressInfoEXT * pInfo);
...
typedef void (GLAD_API_PTR *PFN_vkGetPhysicalDeviceGeneratedCommandsPropertiesNVX)(VkPhysicalDevice physicalDevice, VkDeviceGeneratedCommandsFeaturesNVX * pFeatures, VkDeviceGeneratedCommandsLimitsNVX * pLimits);
...
typedef VkResult (GLAD_API_PTR *PFN_vkRegisterObjectsNVX)(VkDevice device, VkObjectTableNVX objectTable, uint32_t objectCount, const VkObjectTableEntryNVX * const* ppObjectTableEntries, const uint32_t * pObjectIndices);
...
typedef VkResult (GLAD_API_PTR *PFN_vkUnregisterObjectsNVX)(VkDevice device, VkObjectTableNVX objectTable, uint32_t objectCount, const VkObjectEntryTypeNVX * pObjectEntryTypes, const uint32_t * pObjectIndices);
...
GLAD_API_CALL PFN_vkCmdProcessCommandsNVX glad_vkCmdProcessCommandsNVX;
#define vkCmdProcessCommandsNVX glad_vkCmdProcessCommandsNVX
...
GLAD_API_CALL PFN_vkCmdReserveSpaceForCommandsNVX glad_vkCmdReserveSpaceForCommandsNVX;
#define vkCmdReserveSpaceForCommandsNVX glad_vkCmdReserveSpaceForCommandsNVX
...
GLAD_API_CALL PFN_vkCreateIndirectCommandsLayoutNVX glad_vkCreateIndirectCommandsLayoutNVX;
#define vkCreateIndirectCommandsLayoutNVX glad_vkCreateIndirectCommandsLayoutNVX
...
#endif
GLAD_API_CALL PFN_vkCreateObjectTableNVX glad_vkCreateObjectTableNVX;
#define vkCreateObjectTableNVX glad_vkCreateObjectTableNVX
...
GLAD_API_CALL PFN_vkDestroyIndirectCommandsLayoutNVX glad_vkDestroyIndirectCommandsLayoutNVX;
#define vkDestroyIndirectCommandsLayoutNVX glad_vkDestroyIndirectCommandsLayoutNVX
GLAD_API_CALL PFN_vkDestroyInstance glad_vkDestroyInstance;
#define vkDestroyInstance glad_vkDestroyInstance
GLAD_API_CALL PFN_vkDestroyObjectTableNVX glad_vkDestroyObjectTableNVX;
#define vkDestroyObjectTableNVX glad_vkDestroyObjectTableNVX
...
GLAD_API_CALL PFN_vkGetPhysicalDeviceGeneratedCommandsPropertiesNVX glad_vkGetPhysicalDeviceGeneratedCommandsPropertiesNVX;
#define vkGetPhysicalDeviceGeneratedCommandsPropertiesNVX glad_vkGetPhysicalDeviceGeneratedCommandsPropertiesNVX
...
GLAD_API_CALL PFN_vkRegisterObjectsNVX glad_vkRegisterObjectsNVX;
#define vkRegisterObjectsNVX glad_vkRegisterObjectsNVX
...
GLAD_API_CALL PFN_vkUnregisterObjectsNVX glad_vkUnregisterObjectsNVX;
#define vkUnregisterObjectsNVX glad_vkUnregisterObjectsNVX
